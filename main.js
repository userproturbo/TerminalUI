...
const heroAnimLayer = hero?.querySelector(".hero-anim-layer");
const heroLines = heroAnimLayer?.querySelectorAll(".hero-line") ?? [];
const heroSideDots = heroAnimLayer?.querySelectorAll(".hero-dot-side") ?? [];
const heroBottomDots = heroAnimLayer?.querySelectorAll(".hero-dot-bottom") ?? [];
const heroBarsLeft = heroAnimLayer?.querySelectorAll(".hero-bar-left") ?? [];
const heroBarsRight = heroAnimLayer?.querySelectorAll(".hero-bar-right") ?? [];
const scanCenters = heroAnimLayer?.querySelectorAll(".scan-center") ?? [];
